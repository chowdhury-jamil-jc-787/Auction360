<x-backend.layouts.master>
    <x-slot:fav>galleries-Create</x-slot:fav>
        <x-slot:title>galleries-create</x-slot:title>
      ...
      <div class="row">
        ...
        @csrf
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="name" name="name" placeholder="Enter gallery title">
            </div>
            <div class="form-group">
